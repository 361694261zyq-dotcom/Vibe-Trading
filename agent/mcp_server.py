...
def trading_tiger_market(
    ...
    symbols: list[str | dict[str, str]] | None = None,
    identifiers: list[str] | None = None,
    expiry: str | None = None,
    market: str | None = None,
    return_greeks: bool = True,
    option_filter: dict[str, object] | None = None,
    timezone: str | None = None,
    begin_date: str | None = None,
    end_date: str | None = None,
    begin_time: int | str | None = None,
    ...
    """Read complete Tiger option-market data plus session, depth, and ticks."""
    params = {
        "operation": operation,
